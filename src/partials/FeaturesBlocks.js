      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">¿Cuáles son los pasos a seguir con el cliente?</h2>
            <p className="text-xl text-gray-600">Este es el paso a paso que seguiremos juntos hasta que le entreguemos su web.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Puede contactar con nosotros a través llamada, mail, whatsapp.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Acuerdo</h4>
              <p className="text-gray-600 text-center">Con el objetivo marcado, llegamos a un entendimiento en coste y tiempo.</p>
            </div>
