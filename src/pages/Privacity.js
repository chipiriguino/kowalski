...
export default function Privacity() {
  ...
  <a className="btn text-white bg-blue-600 hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0"  href="/">Volver</a>
            <h1>Política de Privacidad</h1>
            
<p>Kowalski-design te informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios y clientes que puedan ser recabados por la navegación o contratación de servicios a través del sitio Web Kowalski-design.com.
...
<li>Titular: Kowalski-design SL</li>
<li>Correo electrónico: kowalskiwebdesign@gmail.com</li>
<li>Sitio Web: Kowalski-design.com</li>
</ul>
<h1>Principios aplicados en el tratamiento de datos</h1>
<br/>
<p>En el tratamiento de tus datos personales, el Titular aplicará los siguientes principios que se ajustan a las exigencias del nuevo reglamento europeo de protección de datos:
...
Para navegar por Kowalski-design.com no es necesario que facilites ningún dato personal. Los casos en los que sí proporcionas tus datos personales son los siguientes:
</p>
<br/>
<p>
...
Para ejercitar tus derechos de acceso, rectificación, cancelación, portabilidad y oposición tienes que enviar un correo electrónico a kowalskiwebdesign@gmail.com junto con la prueba válida en derecho como una fotocopia del D.N.I. o equivalente.
...
Navegación Web
Al navegar por Kowalski-design.com se pueden recoger datos no identificativos, que pueden incluir, la dirección IP, geolocalización, un registro de cómo se utilizan los servicios y sitios, hábitos de navegación y otros datos que no pueden ser utilizados para identificarte.

El Kowalski-design.com utiliza los siguientes servicios de análisis de terceros:
...
Como Usuario del Kowalski-design.com eres el único responsable de la veracidad y corrección de los datos que remitas al sitio exonerando a el Titular de cualquier responsabilidad al respecto.

Aceptación y consentimiento
Como Usuario Kowalski-design.com declaras haber sido informado de las condiciones sobre protección de datos de carácter personal, aceptas y consientes el tratamiento de los mismos por parte de el Titular en la forma y para las finalidades indicadas en esta Política de Privacidad.
